        ...
        <div className='relative z-50 mt-3'>
            <nav className={`container mx-auto px-5 lg:px-0 py-2 flex justify-between items-center transition-all duration-1000 transform ${isVisible ? 'opacity-100' : 'opacity-0'}`}>
                ...
                <div className='hidden md:flex space-x-10'>
                    <Link to='/' className='font-ropa text-white text-xl hover:underline'>
                        Home
                    </Link>
                    <Link to='/skills' className='font-ropa text-white text-xl hover:underline'>
                        Skills
                    </Link>
                    <Link to='/projects' className='font-ropa text-white text-xl hover:underline'>
                        Projects
                    </Link>
                    <Link to='/about' className='font-ropa text-white text-xl hover:underline'>
                        About
                    </Link>
                    <Link to='/contact' className='font-ropa text-white text-xl hover:underline'>
                        Contact
                    </Link>
                </div>

                {/* Hamburger menu icon (small screens) */}
                <button ref={hamburgerIconRef} id='menu-btn' className='block hamburger md:hidden focus:outline-none z-50' onClick={toggleHamburgerIcon}>
            ...
            <div
                ref={mobileMenu}
                className={`fixed top-20 left-0 w-full py-6 bg-darkGrayBackground text-white flex flex-col justify-center items-center transform transition-all duration-500 ease-in-out ${
