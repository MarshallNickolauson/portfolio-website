...
const AboutMeSection = () => {
    ...
    return (
        <section className='py-12 text-center px-4'>
            <h2
                ref={titleRef}
                className={`text-3xl font-bold text-mainBlack ${isVisible ? 'fade-in-bottom' : 'opacity-0'}`}
            ...
            <p
                ref={paragraphRef}
                className={`text-mainGray text-base max-w-3xl mx-auto mt-4 leading-relaxed ${isVisible ? 'fade-in-bottom' : 'opacity-0'}`}
