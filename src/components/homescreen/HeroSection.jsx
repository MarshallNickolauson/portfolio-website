...
const HeroSection = () => {
    ...
    return (
        <>
            ...
            <div
                ref={containerRef}
                className={`bg-gradient-to-t from-white to-mainBlueLight h-[580px] w-full transition-opacity duration-700 ease-out ${isVisible ? 'opacity-100 fade-in-bottom' : 'opacity-0'}`}
            >
                <div className='flex flex-col items-center justify-center h-full'>
                    ...
                    <p className={`font-medium text-mainGray text-[1.3rem] text-center ${isVisible ? 'fade-in-bottom' : 'opacity-0'}`} style={{ animationDelay: '0.3s' }}>
