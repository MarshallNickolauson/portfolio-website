...
const HeroSection = () => {
    return (
        <div className='bg-gradient-to-t from-white to-mainBlueLight h-[650px] w-full pt-[60px]'>
            <div className='flex flex-col items-center justify-center h-full'>
                <h1 className='font-semibold text-[5rem] bg-gradient-to-r from-mainBlue/85 to-mainBlueDark bg-clip-text text-transparent fade-in-bottom' style={{ animationDelay: '0.1s' }}>
                    Hi, I'm Marshall.
                </h1>
                <p className='font-medium text-mainGray text-[1.3rem] text-center fade-in-bottom' style={{ animationDelay: '0.3s' }}>
                    Full Stack Developer specialized in building beautiful,
                    <br />
                    lightning-fast web apps primarily with the MERN stack.
                </p>
                <div className='flex space-x-4 mt-5 fade-in-bottom' style={{ animationDelay: '0.5s' }}>
